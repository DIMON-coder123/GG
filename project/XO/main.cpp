     ...
     int numbermove = 0;
        while(check())
        {
            ...
            if (numbermove % 2 == 0 && numbermove > 0)
            {
                ...
                if ((numbermove == 4) && (table[3][1] != 'O') && (table[1][3] != 'O'))
                {
                    table[1][3] = 'X';
                }

                if (table[1][1] == 'O' && numbermove == 4)
                {
                    system ("cls");
                    table[3][1] = 'X';
                    sleep(1);
                ...
                if ((table[3][1] != 'O') && (numbermove == 4) && (table[1][3] != 'O'))
                {
                    table[3][1] = 'X';
                }
                if ((table[3][1] == 'O') && (numbermove == 4))
                {
                    system ("cls");
                    table[2][1] = 'X';
                    paint();
                }
                if ((table[2][3] != 'O') && (numbermove >= 4))
                {
                    system ("cls");
                    table[2][3] = 'X';
                    paint();
                ...
                if ((table[2][3] == 'O') && (numbermove >= 5))
                {
                    system ("cls");
                    table[3][2] = 'X';
                    paint();
                }
                if ((table[1][2] != 'O') && (numbermove >= 6))
                {
                    system ("cls");
                    table[1][2] = 'X';
                    paint();
